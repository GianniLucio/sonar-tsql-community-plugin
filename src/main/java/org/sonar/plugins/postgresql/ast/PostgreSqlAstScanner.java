...
public class PostgreSqlAstScanner {

    private static final Logger LOG = LoggerFactory.getLogger(PostgreSqlAstScanner.class);
    ...
    public ScanResult parse(String content) {
        ...
        parser.addErrorListener(new BaseErrorListener() {
            ...
            public void syntaxError(Recognizer<?, ?> recognizer, Object offendingSymbol,
                ...
                LOG.debug("PostgreSQL syntax error at line {}:{}: {}", line, charPositionInLine, msg);
            }
        });
        ...
        for (Token token : tokenStream.getTokens()) {
            ...
            if (token.getChannel() == PostgreSqlLexer.HIDDEN) {
                if (token.getType() == PostgreSqlLexer.LINE_COMMENT || token.getType() == PostgreSqlLexer.BLOCK_COMMENT) {
    ...
    public void executeRules(ScanResult scanResult, String fileContent, List<PostgreSqlCheck> checks) {
